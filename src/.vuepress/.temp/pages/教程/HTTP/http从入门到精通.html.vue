<template><div><h2 id="动态字符串类型" tabindex="-1"><a class="header-anchor" href="#动态字符串类型"><span>动态字符串类型</span></a></h2>
<h3 id="动态字符串类型-1" tabindex="-1"><a class="header-anchor" href="#动态字符串类型-1"><span>动态字符串类型</span></a></h3>
<h4 id="动态字符串类型-2" tabindex="-1"><a class="header-anchor" href="#动态字符串类型-2"><span>动态字符串类型</span></a></h4>
<h5 id="动态字符串类型-3" tabindex="-1"><a class="header-anchor" href="#动态字符串类型-3"><span>动态字符串类型</span></a></h5>
<h6 id="动态字符串类型-4" tabindex="-1"><a class="header-anchor" href="#动态字符串类型-4"><span>动态字符串类型</span></a></h6>
<p>####### 动态字符串类型</p>
...
<p>SDS 结构：</p>
<div class="language- line-numbers-mode" data-highlighter="shiki" data-ext="" style="--shiki-light:#383A42;--shiki-dark:#abb2bf;--shiki-light-bg:#FAFAFA;--shiki-dark-bg:#282c34"><pre class="shiki shiki-themes one-light one-dark-pro vp-code" v-pre=""><code><span class="line"><span>struct sdshdr {</span></span>
...
<div class="language- line-numbers-mode" data-highlighter="shiki" data-ext="" style="--shiki-light:#383A42;--shiki-dark:#abb2bf;--shiki-light-bg:#FAFAFA;--shiki-dark-bg:#282c34"><pre class="shiki shiki-themes one-light one-dark-pro vp-code" v-pre=""><code><span class="line"><span>printf("%s", s->buf);</span></span></code></pre>
...
<div class="language- line-numbers-mode" data-highlighter="shiki" data-ext="" style="--shiki-light:#383A42;--shiki-dark:#abb2bf;--shiki-light-bg:#FAFAFA;--shiki-dark-bg:#282c34"><pre class="shiki shiki-themes one-light one-dark-pro vp-code" v-pre=""><code><span class="line"><span>char *strcat(char *dest, const char *src);</span></span></code></pre>
...
<h2 id="链表" tabindex="-1"><a class="header-anchor" href="#链表"><span>链表</span></a></h2>
...
<p>链表结构定义如下：</p>
<div class="language- line-numbers-mode" data-highlighter="shiki" data-ext="" style="--shiki-light:#383A42;--shiki-dark:#abb2bf;--shiki-light-bg:#FAFAFA;--shiki-dark-bg:#282c34"><pre class="shiki shiki-themes one-light one-dark-pro vp-code" v-pre=""><code><span class="line"><span>typedef struct listNode {</span></span>
...
<h2 id="字典" tabindex="-1"><a class="header-anchor" href="#字典"><span>字典</span></a></h2>
</div></template>
