<template><div><h2 id="为什么需要分布式共识算法" tabindex="-1"><a class="header-anchor" href="#为什么需要分布式共识算法"><span>为什么需要分布式共识算法？</span></a></h2>
...
<h2 id="主要分布式共识算法" tabindex="-1"><a class="header-anchor" href="#主要分布式共识算法"><span>主要分布式共识算法</span></a></h2>
<ol>
...
<h2 id="paxos发展历史" tabindex="-1"><a class="header-anchor" href="#paxos发展历史"><span>Paxos发展历史</span></a></h2>
...
<h2 id="basic-paxos算法流程" tabindex="-1"><a class="header-anchor" href="#basic-paxos算法流程"><span>Basic Paxos算法流程</span></a></h2>
...
<p>相比较Basic Paxos算法，Multi Paxos增加了<code v-pre>选主</code>的过程：</p>
<ul>
