<template><div><p>VuePress 是一个基于 Vue.js 的静态网站生成器，比较适合构建个人网站、博客或文档站点。下面将详细的构建过程！</p>
...
<h2 id="增加评论" tabindex="-1"><a class="header-anchor" href="#增加评论"><span>增加评论</span></a></h2>
<h2 id="typora插入图片" tabindex="-1"><a class="header-anchor" href="#typora插入图片"><span>Typora插入图片</span></a></h2>
<p>在使用 Markdwon 写作的时候，用的最多的工具就是 Typora，一个最棘手的问题就是 Markdown 中的图片插入问题，因为 Markdown 中的图片仅为一个 URL，一般需要使用图床。</p>
...
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div></div></div><p>Typora 设置：偏好设置 → 图像 → 选择 [复制到指定路径]。路径名和方法 1 的绝对路径不同，而是同级相对路径。</p>
<p>![image-20250424011412645](使用 VuePress 构建个人知识网站.assets/image-20250424011412645.png)</p>
<p>注意：<strong>文档文件名中不能有空格</strong>！</p>
<h2 id="增加rss支持" tabindex="-1"><a class="header-anchor" href="#增加rss支持"><span>增加RSS支持</span></a></h2>
<h2 id="文章模板" tabindex="-1"><a class="header-anchor" href="#文章模板"><span>文章模板</span></a></h2>
<h2 id="markdown语法" tabindex="-1"><a class="header-anchor" href="#markdown语法"><span>Markdown语法</span></a></h2>
</div></template>
