 ...
 */
declare const discard: <ID, Document, Index extends Record<string, any> = Record<never, never>>(searchIndex: SearchIndex<ID, Document, Index>, id: ID) => void;
/**
 ...
 */
declare const discardAll: <ID, Document, Index extends Record<string, any> = Record<never, never>>(searchIndex: SearchIndex<ID, Document, Index>, ids: readonly ID[]) => void;
/**
 ...
 */
declare const remove: <ID, Document, Index extends Record<string, any> = Record<never, never>>(searchIndex: SearchIndex<ID, Document, Index>, document: Document) => void;
/**
 ...
 * documents.
 */
declare const removeAll: <ID, Document, Index extends Record<string, any> = Record<never, never>>(searchIndex: SearchIndex<ID, Document, Index>, documents?: readonly Document[]) => void;
 ...
 * with
 */
declare const replace: <ID, Document, Index extends Record<string, any> = Record<never, never>>(searchIndex: SearchIndex<ID, Document, Index>, updatedDocument: Document) => void;
 ...
 * {@link VacuumOptions}.
 */
declare const vacuum: <ID, Document, Index extends Record<string, any> = Record<never, never>>(searchIndex: SearchIndex<ID, Document, Index>, options?: VacuumOptions) => Promise<void>;

export { type AutoVacuumOptions, type BM25Params, type CombinationOperator, type Entry, type FuzzyResult, type FuzzyResults, type IndexObject, type LeafType, type LogLevel, type LowercaseCombinationOperator, type MatchInfo, type Path, type Query, type QueryCombination, type RadixTree, SearchIndex, type SearchIndexOptions, type SearchOptions, type SearchResult, SearchableMap, type SerializedIndexEntry, type Suggestion, type VacuumConditions, type VacuumOptions, WILDCARD, type Wildcard, add, addAll, addAllAsync, autoSuggest, createIndex, discard, discardAll, getDefaultValue, getStoredFields, has, loadIndex, loadIndexAsync, loadJSONIndex, loadJSONIndexAsync, remove, removeAll, replace, search, vacuum };
