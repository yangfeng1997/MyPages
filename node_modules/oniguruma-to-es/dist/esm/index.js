  ...
  */
  CharacterClass(node, state, gen) {
    ...
    if (
      ...
      ((!state.useFlagV || !state.verbose) && parent.kind === "union" && !(envFlags.bugLiteralHyphenIsRange && state.useFlagV) || !state.verbose && parent.kind === "intersection" && // JS doesn't allow intersection with union or ranges
