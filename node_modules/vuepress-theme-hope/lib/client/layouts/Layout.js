    ...
    setup(_props, { slots }) {
        ...
        return () => [
            ...
            h(CommonWrapper, {}, {
                default: () => slots.default?.() ??
                    (frontmatter.value.portfolio
                        ...
                        : frontmatter.value.home
                            ? h(HomePage)
                            : h(isPure.value ? RenderDefault : FadeInUpTransition, () => h(NormalPage, { key: page.value.path }, {
                                top: slots.top,
                                bottom: slots.bottom,
                ...
                navScreenBottom: sidebarDisplay.value === "none" && hasGlobalComponent("BloggerInfo")
