...
export default defineComponent({
    ...
    setup() {
        ...
        const lastUpdated = useLastUpdated(() => frontmatter.value.lastUpdated ?? themeLocale.value.lastUpdated ?? true);
        return () => {
            const showChangelog = (frontmatter.value.changelog ?? themeLocale.value.changelog ?? true) &&
            ...
            return h("footer", { class: "vp-page-meta" }, [
                editLink.value
                    ...
                    : null,
                h("div", { class: "vp-meta-item git-info" }, !showChangelog && lastUpdated.value
